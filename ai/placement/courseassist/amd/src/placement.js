...
const AICourseAssist = class {
    ...
    constructor(userId, contextId) {
        ...
        this.actionButtonElement = document.querySelector(Selectors.ELEMENTS.ACTION_BUTTON);
    ...
    registerEventListeners() {
        document.addEventListener('click', async(e) => {
            ...
            if (summariseAction) {
                ...
                await this.displayAction(this.lastAction);
    ...
    closeAIDrawer() {
        ...
        this.actionButtonElement.focus();
