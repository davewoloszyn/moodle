...
abstract class communication_room_base {
    ...
    /**
     * Create a provider room when a new course is created.
     *
     * @return void
     */
    ...
    /**
     * Delete a provider room when a course is deleted.
     *
     * @return void
     */
    ...
    /**
     * Suspend/un suspend a provider room when a course is hidden.
     *
     * @param bool $enable The status of the room
     * @return void
     */
    abstract public function status(bool $enable = true): void;

    /**
     * Update a provider room when a course is updated.
     *
     * @return void
     */
