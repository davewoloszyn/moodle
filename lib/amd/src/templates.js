...
define([
    ...
    Renderer.prototype.quoteHelper = function(context, sectionText, helper) {
        ...
        // Escape the \ to prevent escaping other characters.
        // Escape the " to prevent breaking JSON syntax
        // Escape the {{. This involves wrapping {{, and }} in change delimeter tags.
        content = content
            .replace(/\\/g, '\\\\')
            .replace(/"/g, '\\"')
            .replace(/\t/g, '&#9;')
