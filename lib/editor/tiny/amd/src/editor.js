...
/**
 * Move the UI container near the editor.
 *
 ...
 * Moving the menu container into the parent editor container makes it works correctly.
 *
 * @param {object} editor
 */
 const moveUIContainer = (editor) => {
