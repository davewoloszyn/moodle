...
import {MediaThumbnailInsert} from './mediathumbnailinsert';
import {getEmbeddedMediaDetails} from './mediahelpers';
    ...
    showUploadThumbnail = async() => {
        ...
        Promise.all([body(templateContext, root), footer(templateContext, root)])
            .then(() => {
                ...
                const mediaThumbnailInsert = new MediaThumbnailInsert(this);
