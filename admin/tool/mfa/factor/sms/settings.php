...
if ($ADMIN->fulltree) {
    ...
    // Hide all the other settings until we have a gateway selected.
    $settings->hide_if('factor_sms/enabled', 'factor_sms/smsgateway', 'eq', '0');
    $settings->hide_if('factor_sms/weight', 'factor_sms/smsgateway', 'eq', '0');
    $settings->hide_if('factor_sms/duration', 'factor_sms/smsgateway', 'eq', '0');
}
