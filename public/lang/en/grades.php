...
$string['noscales'] = 'Learning outcomes must be linked to a course scale or global scale, but there are none. Would you like to add one?';
...
$string['outcomescoursecustom'] = 'Course learning outcome used (no remove)';
$string['outcomescoursenotused'] = 'Site-wide learning outcome not used';
$string['outcomescourseused'] = 'Site-wide learning outcome used (no remove)';
