...
$string['cannotuselocalscopeinglobal'] = 'Cannot use a course-specific scale in a site-wide (standard) learning outcome.';
...
$string['enableoutcomes_help'] = 'If enabled, teachers can define intended learning outcomes for their courses, tag activities and assessments against those outcomes, and students can see the outcomes and understand which activity contributes to each one. Legacy graded outcomes (tied to scales) continue to work when this is enabled.';
$string['learningoutcomes'] = 'Learning outcomes';
$string['learningoutcomesalignment'] = 'Course alignment';
$string['learningoutcomesaddtolearningoutcomes'] = 'Add to course';
$string['learningoutcomesalignmentreport'] = 'Alignment report';
$string['learningoutcomescoverage'] = '{$a->tagged}/{$a->total} activities tagged';
$string['learningoutcomescourse'] = 'Course learning outcomes';
$string['learningoutcomescoursealignmentreport'] = 'Course alignment report';
$string['learningoutcomescoursedefault'] = 'Enable for new courses by default';
$string['learningoutcomescoursedefault_help'] = 'If enabled, learning outcomes will be turned on for all new courses by default. Teachers can override this setting for their individual course.';
$string['learningoutcomescoursedisabled'] = 'Learning outcomes are not enabled for this course.';
$string['learningoutcomescourseenabled'] = 'Enable learning outcomes for this course';
$string['learningoutcomescourseenabled_help'] = 'If enabled, learning outcomes are active for this course. Teachers can define intended learning outcomes, tag activities against them, and students can see the outcomes and how activities relate to them.';
$string['learningoutcomescreate'] = 'Add a learning outcome';
$string['learningoutcomesdelete'] = 'Delete learning outcome';
$string['learningoutcomesdeleteinuse'] = 'The learning outcome "{$a}" cannot be deleted because it is currently used by one or more grade items.';
$string['learningoutcomesdeleteconfirm'] = 'Are you sure you want to delete the learning outcome \'{$a}\'? All activity tags for this outcome will also be removed.';
$string['learningoutcomesremovefromcourse'] = 'Remove learning outcome from course';
$string['learningoutcomesremovefromcourseconfirm'] = 'Are you sure you want to remove the learning outcome \'{$a}\' from this course? This will remove this course\'s activity tags for the outcome, but will not delete the standard outcome site-wide.';
$string['learningoutcomesenforcement'] = 'Minimum outcomes enforcement';
$string['learningoutcomesenforcement_help'] = 'Controls how the minimum outcomes requirement is enforced. Soft shows a strong nudge but does not block saving. Hard prevents a course from being saved or published until the minimum is met.';
$string['learningoutcomesenforcementhard'] = 'Hard (block save/publish)';
$string['learningoutcomesenforcementsoft'] = 'Soft (strong nudge only)';
$string['learningoutcomesinherit'] = 'Use site default';
$string['learningoutcomesmanage'] = 'Manage learning outcomes';
$string['learningoutcomesmin'] = 'Minimum learning outcomes per course';
$string['learningoutcomesmin_help'] = 'The minimum number of learning outcomes that should be defined for a course. Set to 0 to disable the minimum requirement. The enforcement mode (hard or soft) controls whether saving is blocked until this threshold is met.';
$string['learningoutcomesnudge'] = 'This course has {$a->count} learning outcome(s) defined. The recommended minimum is {$a->min}.';
$string['learningoutcomesnudgebelow'] = 'This course has only {$a->count} learning outcome(s). Please add at least {$a->remaining} more to meet the recommended minimum of {$a->min}.';
$string['learningoutcomesnudgehard'] = 'This course requires at least {$a->min} learning outcome(s) before it can be saved. Please add {$a->remaining} more.';
$string['learningoutcomesnoactivities'] = 'No activities are tagged to this outcome yet.';
$string['learningoutcomesnone'] = 'No learning outcomes have been defined for this course yet.';
$string['learningoutcomesoutcometype'] = 'Outcome type';
$string['learningoutcomesoutcometypecourse'] = 'Course';
$string['learningoutcomesoutcometypestandard'] = 'Standard';
$string['learningoutcomesnooutcomes'] = 'This activity has not been tagged with any learning outcomes.';
$string['learningoutcomespageheading'] = 'Learning outcomes: {$a}';
$string['learningoutcomesscaleoptional'] = 'Scale (optional)';
$string['learningoutcomesscaleoptional_help'] = 'Optionally link this learning outcome to a grading scale. This enables graded outcome tracking in the gradebook. Leave blank for a lightweight tag-only outcome with no grading.';
$string['learningoutcomestagactivities'] = 'Tag activities';
$string['learningoutcomestagactivitiesheading'] = 'Tag activities to learning outcomes';
$string['learningoutcomestagactivity'] = 'Tag this activity';
$string['learningoutcomestagactivityfor'] = 'Tag activities for: {$a}';
$string['learningoutcomestertiarynavigation'] = 'Learning outcomes tertiary navigation';
$string['learningoutcomesuntagged'] = 'Untagged activities';
$string['learningoutcomesuntaggedcount'] = '{$a} activity/activities with no learning outcome tag';
$string['learningoutcomeswithnoactivities'] = '{$a} learning outcome(s) with no supporting activities';
...
$string['outcomefullname_help'] = 'The full descriptive name for this learning outcome.';
...
$string['shortnametaken'] = 'The short name "{$a}" is already used by another outcome. Please choose a different short name.';
