...
$string['check_securitymessages_details'] = '<p>Some security-critical message notifications should be forced on so that users cannot opt out of receiving them. This includes new login alerts sent via email and mobile push notifications.</p><p>If these are not forced and the account is compromised the attacker could disable these notifications to cover their tracks.</p>';
